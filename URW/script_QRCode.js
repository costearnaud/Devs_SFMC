...
QRBitBuffer.prototype = {
  ...
  put: function (pnum, plength) {
    for (var i = 0; i < plength; i++) {
      this.putBit(((pnum >>> (plength - i - 1)) & 1) == 1);
    }
  },
      ...
      if (inlineStyle) {
        aHTML.push(
          indent +
            ...
            nHeight +
            "px;background-color:" +
            (module ? options.color : options.background) +
            ';"></td>' +
            EOL
        );
      } else {
        aHTML.push(
          indent +
            indent +
            "<td" +
            (module ? ' class="' + dataModuleClassNames + '"' : "") +
            "></td>" +
            EOL
        );
      }
